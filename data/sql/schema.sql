...
CREATE TABLE sf_guard_user_profile (id BIGINT AUTO_INCREMENT, user_id INT, email VARCHAR(255), first_name VARCHAR(255), last_name VARCHAR(255), preposition VARCHAR(255), image VARCHAR(255), is_invite TINYINT(1) DEFAULT '0', INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE sf_doctrine_simple_forum_topic ADD CONSTRAINT slsi_1 FOREIGN KEY (latest_post_id) REFERENCES sf_doctrine_simple_forum_post(id);
