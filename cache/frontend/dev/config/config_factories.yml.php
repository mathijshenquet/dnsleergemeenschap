...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/mathijs/Webserver/leerlingensite/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/mathijs/Webserver/leerlingensite/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/mathijs/Webserver/leerlingensite/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('leerlingensite'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'leerlingensite',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/mathijs/Webserver/leerlingensite/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/mathijs/Webserver/leerlingensite/apps/frontend/template',
)));
