 ...
 * @property Doctrine_Collection $Showcase
 * 
 ...
 * @method Doctrine_Collection getShowcase()                       Returns the current record's "Showcase" collection
 ...
 * @method sfGuardUser         setSfDoctrineSimpleForumTopicView() Sets the current record's "sfDoctrineSimpleForumTopicView" collection
 * @method sfGuardUser         setStatus()                         Sets the current record's "Status" collection
 * @method sfGuardUser         setProfile()                        Sets the current record's "Profile" value
 * @method sfGuardUser         setShowcase()                       Sets the current record's "Showcase" collection
 * 
 * @package    leerling
 * @subpackage model
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('sfDoctrineSimpleForumTopic as Topics', array(
             'local' => 'id',
             'foreign' => 'user_id'));
        ...
        $this->hasMany('showcase as Showcase', array(
             'local' => 'id',
             'foreign' => 'user_id'));
