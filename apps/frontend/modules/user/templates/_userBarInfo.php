...
<div id="userbar" class="info">
  <ul>
  	...
  	<li class="admin">
  		...
  		<?php echo link_to('Beheer', '@backend.homepage', array('id'=>'beheer')); ?>
  	</li>
  	<?php endif; ?>
  	<?php if(sfConfig::get('app_feedback_active', false)): ?>
  	<li class="feedback">
  		<label for="feedback">Feedback</label>
  		<?php echo link_to('Feedback', '@feedback', array('id'=>'feedback')); ?>
  	</li>
  	<?php endif; ?>
